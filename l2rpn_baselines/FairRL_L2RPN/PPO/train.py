...
def main():
    ...
    tp.model_name ="PPO-{}-50-2000-big-1_10".format(int(time.time()))
    ...
    #                     "set_topo_vect": False
    #                     }
    save_path = "../Outputs/Results/PPO/{}".format(tp.model_name)
    logs_dir = "../Outputs/logs/PPO/{}".format(tp.model_name)
    load_path = None
    num_epochs = 50
