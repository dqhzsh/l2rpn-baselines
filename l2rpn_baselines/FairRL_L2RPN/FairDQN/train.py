...
from FairDQN.fairDQN import DeepQAgent
...
def main():
    ...
    tp.model_name = "FairDQN-{}-10000-500-big-A-O".format(int(time.time()))
    ...
    sizes = [128,256]  # sizes of each hidden layers
    ...
    save_path = "../Outputs/Results/FairDQN/{}".format(tp.model_name)
    logs_dir = "../Outputs/logs/FairDQN/{}".format(tp.model_name)
    load_path = None
