...
class DoubleDuelingRDQN_NN(object):
    ...
    def bayesian_move(self, data, mem, carry, prev_a, prev_r, rate = 0.0):
    ...
    def random_move(self, data, mem, carry, prev_a, prev_r):
        self.trace_length.assign(1)
    ...
    def predict_move(self, data, mem, carry, prev_a, prev_r):
        self.trace_length.assign(1)
        self.dropout_rate.assign(0.0)
