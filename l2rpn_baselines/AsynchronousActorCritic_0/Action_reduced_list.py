...
#     k = 1
#     # environment.action_space({"change_bus":{"generators_id": [0],"loads_id": [1],"lines_or_id":[3],"lines_ex_id":[7]}})
#     np.save("gen_action_list_1.npy", gen_action_list)
#     np.save("load_action_list_1.npy", load_action_list)
#     np.save("line_or_action_list_1.npy", line_or_action_list)
#     np.save("line_ex_action_list_1.npy", line_ex_action_list)
#     return gen_action_list, load_action_list, line_or_action_list, line_ex_action_list
#
# def main_function(bus_no):
#     # There are a total of 4 files.
#     file_names = ["gen_action_list_1","load_action_list_1","line_or_action_list_1","line_ex_action_list_1"]
#     flag_check = None
#     for index_item, item in enumerate(file_names):
#         flag_check = os.path.isfile(item+".npy")
#         if flag_check == False:
...
#     if flag_check == True:
#         # load the data from the saved files.
#         gen_action_list = np.load("gen_action_list_1.npy",allow_pickle=True)
#         load_action_list = np.load("load_action_list_1.npy",allow_pickle=True)
#         line_or_action_list = np.load("line_or_action_list_1.npy",allow_pickle=True)
#         line_ex_action_list = np.load("line_ex_action_list_1.npy",allow_pickle=True)
#     return gen_action_list, load_action_list, line_or_action_list, line_ex_action_list
